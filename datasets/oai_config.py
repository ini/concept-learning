...
CACHE_LIMIT = 1e8
EST_TIME_PER_EXP = 4
BASE_DIR = "/data/Datasets/bottleneck/"
DATA_DIR = "/data/Datasets/oia_processed/"
OUTPUTS_DIR = os.path.join(BASE_DIR, "outputs")
IMG_DIR_PATH = os.path.join(
    DATA_DIR,
    "%s/show_both_knees_True_downsample_factor_None_normalization_method_our_statistics",
)
