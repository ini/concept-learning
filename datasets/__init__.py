...
DATASET_INFO = {
    'mnist_modulo': {
        'concept_type': 'binary', 'concept_dim': 5, 'num_classes': 10},
    'pitfalls_mnist_without_45': {
        'concept_type': 'binary', 'concept_dim': 2, 'num_classes': 2},
    'pitfalls_random_concepts': {
        'concept_type': 'binary', 'concept_dim': 100, 'num_classes': 2},
    'pitfalls_synthetic': {
        'concept_type': 'binary', 'concept_dim': 3, 'num_classes': 2},
    'pitfalls_mnist_123456': {
        'concept_type': 'binary', 'concept_dim': 3, 'num_classes': 2},
    'cifar100': {
        'concept_type': 'binary', 'concept_dim': 20, 'num_classes': 100},
    'cub': {
        'concept_type': 'binary', 'concept_dim': 112, 'num_classes': 200},
    'oai': {
        'concept_type': 'continuous', 'concept_dim': 10, 'num_classes': 4},
}
